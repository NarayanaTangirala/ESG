...
import {
  DomSanitizer
} from "./chunk-LZLBG6UJ.js";
import "./chunk-ADCPBSEN.js";
import {
  BidiModule,
  Directionality,
  coerceBooleanProperty
} from "./chunk-WTHDNBUN.js";
import {
  DOCUMENT,
  NgClass,
  NgStyle,
...
var ShowHideDirective = class extends BaseDirective2 {
  ...
  trackExtraTriggers() {
    ...
    ["layout", "layout-align"].forEach((key) => {
      this.marshal.trackValue(this.nativeElement, key).pipe((0, import_operators2.takeUntil)(this.destroySubject)).subscribe(this.triggerUpdate.bind(this));
    });
  }
  /**
...
var LayoutGapDirective = class extends BaseDirective2 {
  constructor(elRef, zone, directionality, styleUtils, styleBuilder, marshal) {
    ...
    this.marshal.trackValue(this.nativeElement, "layout").pipe((0, import_operators3.takeUntil)(this.destroySubject)).subscribe(this.onLayoutChange.bind(this));
  }
...
var FlexDirective = class extends BaseDirective2 {
  ...
  ngOnInit() {
    if (this.parentElement) {
      this.marshal.trackValue(this.parentElement, "layout").pipe((0, import_operators3.takeUntil)(this.destroySubject)).subscribe(this.onLayoutChange.bind(this));
      this.marshal.trackValue(this.nativeElement, "layout-align").pipe((0, import_operators3.takeUntil)(this.destroySubject)).subscribe(this.triggerReflow.bind(this));
    }
  }
  /**
...
var FlexOffsetDirective = class extends BaseDirective2 {
  constructor(elRef, directionality, styleBuilder, marshal, styler) {
    ...
    if (this.parentElement) {
      this.marshal.trackValue(this.parentElement, "layout-gap").pipe((0, import_operators3.takeUntil)(this.destroySubject)).subscribe(this.triggerUpdate.bind(this));
    }
  }
  // *********************************************
  // Protected methods
